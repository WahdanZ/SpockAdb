...
interface AdbController {
    ...
    fun currentApplicationBackStack(
        device: IDevice,
    ...
    fun getApplicationPermissions(
        device: IDevice, block: (devices: List<PermissionListItem>) -> Unit,
        error: (message: String) -> Unit
    )

    fun grantOrRevokeAllPermissions(
        device: IDevice, permissionOperation: GetApplicationPermission.PermissionOperation,
        success: (message: String) -> Unit, error: (message: String) -> Unit
    )

    fun revokePermission(
        device: IDevice, permissionListItem: PermissionListItem, success: (message: String) -> Unit,
        error: (message: String) -> Unit
    )
    ...
    fun enableDisableDontKeepActivities(
        device: IDevice,
        success: (message: String) -> Unit,
        error: (message: String) -> Unit
    )
    ...
    fun enableDisableShowLayoutBounds(
        device: IDevice,
        success: (message: String) -> Unit,
        error: (message: String) -> Unit
    )

    fun setWindowAnimatorScale(
        scale: String,
        device: IDevice,
        success: (message: String) -> Unit,
        error: (message: String) -> Unit
    ...
    fun setTransitionAnimatorScale(
        scale: String,
        device: IDevice,
        success: (message: String) -> Unit,
        error: (message: String) -> Unit
